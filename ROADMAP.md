...
| 013 | planned | [Calibrate and validate coupled model](tasks/013-calibrate-and-validate-coupled-model.md) | Ready to calibrate the periodic coupled baseline and validate interventions against measurements, paper outputs, and Nektar references. | Maybe |
