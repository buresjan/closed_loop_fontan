...
This model family is reserved for the future coupled 0-D/1-D Fontan closed-loop model.

Planned intent:

- keep the closed-loop 0-D circulation around the 1-D subdomains;
- model the aorta with a true 1-D model;
